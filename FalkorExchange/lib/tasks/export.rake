...
namespace :export do
  ...
  task :blockchains, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_blockchains.to_yaml)
  end
  ...
  task :currencies, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_currencies.to_yaml)
  end
  ...
  task :markets, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_markets.to_yaml)
  end
  ...
  task :wallets, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_wallets.to_yaml)
  end
  ...
  task :trading_fees, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_trading_fees.to_yaml)
  end
  ...
  task :engines, [:export_path] => [:environment] do |_, args|
    ...
    File.write(args.export_path, Falkor Exchange::Export.new.export_engines.to_yaml)
  end
