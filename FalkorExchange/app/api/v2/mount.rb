...
module API
  module V2
    class Mount < Grape::API
      ...
      # Add swagger documentation for Falkor Exchange User API
      add_swagger_documentation base_path:   File.join(API::Mount::PREFIX, API_VERSION, 'falkor'),
                                add_base_path: true,
                                mount_path:  '/swagger',
                                api_version: API_VERSION,
                                doc_version: Falkor Exchange::Application::VERSION,
                                info: {
                                  title:         "Falkor Exchange User API #{API_VERSION}",
                                  description:   'API for Falkor Exchange application.',
                                  contact_name:  'openware.com',
                                  contact_email: 'hello@openware.com',
                                  contact_url:   'https://www.openware.com',
                                  licence:       'MIT',
                                  license_url:   'https://github.com/openware/falkor/blob/master/LICENSE.md'
                                },
                                models: [
