  ...
  module V2
    module Management
      class Mount < Grape::API
        ...
        # Add swagger documentation for Falkor Exchange Management API
        add_swagger_documentation base_path: File.join(API::Mount::PREFIX, API::V2::Mount::API_VERSION, PREFIX, 'falkor'),
                                  add_base_path: true,
                                  mount_path:  '/swagger',
                                  api_version: API::V2::Mount::API_VERSION,
                                  doc_version: Falkor Exchange::Application::VERSION,
                                  info: {
                                    title:          "Falkor Exchange Management API #{API::V2::Mount::API_VERSION}",
