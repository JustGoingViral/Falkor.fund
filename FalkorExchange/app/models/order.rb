...
class Order < ApplicationRecord
  ...
  class << self
    ...
    def cancel(id)
      ...
      return order.trigger_third_party_cancellation unless market_engine.falkor_engine?
  ...
  def submit_order
    ...
    return trigger_third_party_creation unless market.engine.falkor_engine?
  ...
  def trigger_cancellation
    market.engine.falkor_engine? ? trigger_internal_cancellation : trigger_third_party_cancellation
  end
