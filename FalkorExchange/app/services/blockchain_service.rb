class BlockchainService
  ...
  def initialize(blockchain)
    ...
    @adapter = Falkor Exchange::Blockchain.registry[blockchain.client.to_sym].new
  ...
  rescue Falkor Exchange::Blockchain::Error => e
    report_exception(e)
  ...
  def fetch_transaction(transaction)
    tx = Falkor Exchange::Transaction.new(currency_id: transaction.currency_id,
