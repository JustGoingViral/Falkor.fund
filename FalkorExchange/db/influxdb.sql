CREATE DATABASE falkor_development;
CREATE DATABASE falkor_test;

CREATE CONTINUOUS QUERY "trade_to_cq_1m" ON falkor_development
...
CREATE CONTINUOUS QUERY "candles_1m_to_cq_1m" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_5m" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_15m" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_30m" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_1h" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_2h" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_4h" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_6h" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_12h" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_1d" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_3d" ON falkor_development
...
CREATE CONTINUOUS QUERY "cq_1w" ON falkor_development
