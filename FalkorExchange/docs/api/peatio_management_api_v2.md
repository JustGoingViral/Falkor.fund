# Falkor Exchange Management API v2
...
### /api/v2/management/falkor/beneficiaries
...
### /api/v2/management/falkor/beneficiaries/list
...
### /api/v2/management/falkor/accounts/balances
...
### /api/v2/management/falkor/accounts/balance
...
### /api/v2/management/falkor/deposits/state
...
### /api/v2/management/falkor/deposits/new
...
| ---- | ---------- | ----------- | -------- | ---- |
| uid | formData | The shared user ID. | Yes | string |
| tid | formData | The shared transaction ID. Must not exceed 64 characters. Falkor Exchange will generate one automatically unless supplied. | No | string |
| currency | formData | The currency code. | Yes | string |
...
### /api/v2/management/falkor/deposits/get
...
### /api/v2/management/falkor/deposits
...
### /api/v2/management/falkor/withdraws/action
...
### /api/v2/management/falkor/withdraws/new
...
### /api/v2/management/falkor/withdraws/get
...
### /api/v2/management/falkor/withdraws
...
### /api/v2/management/falkor/timestamp
...
### /api/v2/management/falkor/assets/new
...
### /api/v2/management/falkor/assets
...
### /api/v2/management/falkor/expenses/new
...
### /api/v2/management/falkor/expenses
...
### /api/v2/management/falkor/revenues/new
...
### /api/v2/management/falkor/revenues
...
### /api/v2/management/falkor/liabilities/new
...
### /api/v2/management/falkor/liabilities
...
### /api/v2/management/falkor/orders/cancel
...
### /api/v2/management/falkor/orders/{id}/cancel
...
### /api/v2/management/falkor/orders
...
### /api/v2/management/falkor/transfers/new
...
### /api/v2/management/falkor/trades
...
### /api/v2/management/falkor/members/group
...
### /api/v2/management/falkor/members
...
### /api/v2/management/falkor/fee_schedule/trading_fees
...
### /api/v2/management/falkor/currencies/update
...
### /api/v2/management/falkor/currencies/{code}
...
### /api/v2/management/falkor/currencies/list
...
### /api/v2/management/falkor/markets/list
...
### /api/v2/management/falkor/markets/update
