...
1. <https://github.com/rubykube/falkor/blob/1-8-stable/app/api/api_v2/orders.rb#L52>
2. <https://github.com/rubykube/falkor/blob/1-8-stable/app/services/ordering.rb#L12>
...
Daemon `Worker::TradeExecutor` receives IDs of two orders which are matched. Then it attempts to modify balances on each account. See https://github.com/rubykube/falkor/blob/1-8-stable/app/trading/matching/executor.rb#L53

The whole code it wrapped into transaction.

Orders are locked at:

- <https://github.com/rubykube/falkor/blob/1-8-stable/app/trading/matching/executor.rb#L57>

Accounts are locked at:

- <https://github.com/rubykube/falkor/blob/1-8-stable/app/trading/matching/executor.rb#L81>

- <https://github.com/rubykube/falkor/blob/1-8-stable/app/trading/matching/executor.rb#L82>

Full text available from: [Performance of order creation, matching & trade execution](https://github.com/rubykube/falkor/issues/1145)
...
Was used simple Docker deployment, a little modified <https://github.com/rubykube/toolbox#stress-testing-falkor-trading-engine> utility so it creates orders with predictable results and fresh database. 
...
For Falkor Exchange 1.8.9 + [#1110](https://github.com/rubykube/falkor/pull/1110) on top of it.
...
For Falkor Exchange 1.8.9 + [#1110](https://github.com/rubykube/falkor/pull/1110), [#1215](https://github.com/rubykube/falkor/pull/1215), [#1193](https://github.com/rubykube/falkor/pull/1193) and on top of patches [#1214](https://github.com/rubykube/falkor/pull/1214). 
...
```
Root URL:                        http://falkor.trade:4000
Currencies:                      BTC, USD
Markets:                         BTCUSD
