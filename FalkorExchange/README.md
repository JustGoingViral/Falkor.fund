![Cryptocurrency Exchange Platform - Baseapp](https://github.com/openware/meta/raw/main/images/github_falkor.png)

<h3 align="center">
<a href="https://www.openware.com/sdk/docs.html#falkor">Guide</a> <span>&vert;</span> 
<a href="https://www.openware.com/sdk/api/falkor/falkor-user-api-v2.html">API Docs</a> <span>&vert;</span> 
<a href="https://www.openware.com/">Consulting</a> <span>&vert;</span> 
<a href="https://t.me/falkor">Community</a>
</h3>
<h6 align="center">Component part of <a href="https://github.com/openware/opendax">OpenDAX Trading Platform</a></h6>

---

# Falkor Exchange - Cryptocurrency Exchange Software

[![Build Status](https://ci.openware.work/api/badges/openware/falkor/status.svg)](https://ci.openware.work/openware/falkor)
[![Telegram Chat](https://cdn.rawgit.com/Patrolavia/telegram-badge/8fe3382b/chat.svg)](https://t.me/falkor)

## What is Falkor Exchange

Falkor Exchange is a free and open-source crypto-currency exchange implementation with the Rails framework.
This is a fork of Falkor Exchange designed for micro-services architecture. We have simplified the code
in order to use only Falkor Exchange API with external frontend and server components.

Falkor Exchange is the core accounting component and configuration for markets; it is part of OpenDAX system.
...
To build your own exchange you should now run Falkor Exchange as a backend instead of forking the repository,
...
We provide webinar or on site training for installing, configuring and administration best practices of Falkor Exchange.
...
* Built-in [plugable coin API](https://www.openware.com/sdk/2.6/docs/falkor/coins/development.html)
...
Please see [CONTRIBUTING.md](https://www.openware.com/sdk/2.6/docs/falkor/contributing.html) for details on how to contribute
issues, fixes, and patches to this project.

## Getting Started

We advice to use [minimalistic environment](#minimalistic-local-development-environment-with-docker-compose) if you want to develop only Falkor Exchange and don't touch processes which interact with other components.
...
2. Start falkor daemons `god -c lib/daemons/daemons.god`
3. Add this to your `/etc/hosts`:
```
127.0.0.1 www.app.local
127.0.0.1 falkor.app.local
...
We suggest you to start using Falkor Exchange by installing [OpenDAX](https://github.com/openware/opendax).
...
Falkor Exchange crypto exchange software development environment.
...
Follow [OpenDAX](https://github.com/openware/opendax) documentation for the latest Falkor Exchange installation information.
...
```sh
$> docker-compose run --rm falkor bash -c "bundle exec rake db:create db:migrate db:seed"
$> docker-compose up -d falkor
```

After all of that you can start using Falkor Exchange in your browser just by following one of the hosts which you added earlier.

## API

You can interact with Falkor Exchange through API:
...
## Getting Involved
We want to make it super-easy for Falkor Exchange users and contributors to talk to us and connect with each other, to share ideas, solve problems and help make Falkor Exchange awesome. Here are the main channels we're running currently, we'd love to hear from you on one of them:

### Discourse

[Rubykube Discourse Forum](https://discuss.rubykube.io)

This is for all Falkor Exchange users. You can find guides, recipes, questions, and answers from Snowplow users including the Falkor Exchange.tech team.
We welcome questions and contributions!

### Telegram

[@falkor](https://t.me/falkor)

Chat with us and other community members on Telegram.

### GitHub
Falkor Exchange issues

If you spot a bug, then please raise an issue in our main GitHub project (Openware Falkor Exchange)[https://github.com/openware/falkor/]; likewise, if you have developed a new feature or an improvement in your Rubykube Falkor Exchange fork, then send us a pull request!
...
If you need help with running/deploying/customizing Falkor Exchange,
...
Falkor Exchange is released under the terms of the [MIT license](http://falkor.mit-license.org).

## What is Falkor Exchange?

[Falkor Exchange](http://en.wikipedia.org/wiki/Pixiu) (Chinese: 貔貅) is a Chinese mythical hybrid creature
