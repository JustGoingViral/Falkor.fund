describe OWHDWallet::WalletETH do
  ...
  context :configure do
    ...
    it 'requires wallet' do
      expect { wallet.configure(settings.except(:wallet)) }.to raise_error(Falkor Exchange::Wallet::MissingSettingError)

      expect { wallet.configure(settings) }.to_not raise_error
    end

    it 'requires currency' do
      expect { wallet.configure(settings.except(:currency)) }.to raise_error(Falkor Exchange::Wallet::MissingSettingError)
  ...
  context :create_address! do
    ...
    it 'should return error' do
      ...
      expect { wallet.create_address!(uid: 'UID123') }.to raise_error(Falkor Exchange::Wallet::ClientError)
    end
  end
  ...
  context :prepare_deposit_collection! do
    ...
    let(:transaction) do
      Falkor Exchange::Transaction.new(amount: 1.1.to_d, to_address: '0x6d6cabaa7232d7f45b143b445114f7e92350a2aa')
    end
