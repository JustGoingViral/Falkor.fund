describe Bitcoin::Blockchain do
  ...
  context :configure do
    ...
    it 'currencies and server configuration' do
      ...
      expect(blockchain.settings).to eq(settings.slice(*Falkor Exchange::Blockchain::Abstract::SUPPORTED_SETTINGS))
    end
  end
  ...
  context :transaction_sources do
    ...
    context 'transaction 3 vins' do
      ...
      let(:transaction) { Falkor Exchange::Transaction.new(hash: 'b3aa85765aa52cf7eb0a7f0eb7ac3447b9b1a82b9323bdd8d73fc305073a3711') }
      let(:vin1_transaction) { Falkor Exchange::Transaction.new(hash: '1ec4bf89b77f0d72ee41f41c97a6d380bd69e0221bf182b993b64bb37d017b57') }
      let(:vin2_transaction) { Falkor Exchange::Transaction.new(hash: '8bde1da3d2315e09f910cb9782018fe243740c56cd7ca78a19016b169e74180a') }
      let(:vin3_transaction) { Falkor Exchange::Transaction.new(hash: '64a04cad438b64e260bc0b832bde79913d618d3206e834de66bbcb1304629d61') }
    ...
    context 'miner transaction' do
      let(:transaction) { Falkor Exchange::Transaction.new(hash: '1da4b5a135cc0fee9d3aeb5428a898fd12fe5b1b777fd291dbbdbb72c2da8759') }
  ...
  context :latest_block_number do
    ...
    it 'raises error if there is error in response body' do
      ...
      expect{ blockchain.latest_block_number }.to raise_error(Falkor Exchange::Blockchain::ClientError)
    end
  ...
  context :load_balance_of_address! do
    ...
    context 'address is not defined' do
      it 'requests rpc listaddressgroupings and do not find address' do
        ...
        expect{ blockchain.load_balance_of_address!(address, :btc)}.to raise_error(Falkor Exchange::Blockchain::UnavailableAddressBalanceError)
      end
    end
    ...
    context 'client error is raised' do
      ...
      it 'raise wrapped client error' do
        expect{ blockchain.load_balance_of_address!('anything', :btc)}.to raise_error(Falkor Exchange::Blockchain::ClientError)
      end
    end
  end
end
