  ...
  context 'aasm_state' do
    ...
    context :load do
      ...
      it 'transitions to :confirming after calling #load! when withdrawing coin currency' do
        BlockchainService.any_instance.expects(:fetch_transaction).once.returns(Falkor Exchange::Transaction.new)
    ...
    context :fail do
      ...
      context 'from errored' do
        before do
          ...
          subject.err!(Falkor Exchange::Wallet::ClientError.new('Something wrong with request'))
        end
